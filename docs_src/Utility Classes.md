...
### *obj*.**get**`#!py3 (self, section, option, *, raw=False, vars=None, fallback=<object object at 0x01204920>)` { #get data-toc-label=get }
...
### *obj*.**getboolean**`#!py3 (self, section, option, *, raw=False, vars=None, fallback=<object object at 0x01204920>, **kwargs)` { #getboolean data-toc-label=getboolean }


### *obj*.**getfloat**`#!py3 (self, section, option, *, raw=False, vars=None, fallback=<object object at 0x01204920>, **kwargs)` { #getfloat data-toc-label=getfloat }


### *obj*.**getint**`#!py3 (self, section, option, *, raw=False, vars=None, fallback=<object object at 0x01204920>, **kwargs)` { #getint data-toc-label=getint }
...
### *obj*.**items**`#!py3 (self, section=<object object at 0x01204920>, raw=False, vars=None)` { #items data-toc-label=items }
...
### *obj*.**pop**`#!py3 (self, key, default=<object object at 0x01204098>)` { #pop data-toc-label=pop }
...
### *SafeConfigParser*.**converters** *class 'property'* default: *configparser.ConverterMapping object at 0x04810690* { #converters data-toc-label=converters }

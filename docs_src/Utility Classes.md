...
### *obj*.**get**`#!py3 (self, section, option, *, raw=False, vars=None, fallback=<object object at 0x00E84920>)` { #get data-toc-label=get }
...
### *obj*.**getboolean**`#!py3 (self, section, option, *, raw=False, vars=None, fallback=<object object at 0x00E84920>, **kwargs)` { #getboolean data-toc-label=getboolean }


### *obj*.**getfloat**`#!py3 (self, section, option, *, raw=False, vars=None, fallback=<object object at 0x00E84920>, **kwargs)` { #getfloat data-toc-label=getfloat }


### *obj*.**getint**`#!py3 (self, section, option, *, raw=False, vars=None, fallback=<object object at 0x00E84920>, **kwargs)` { #getint data-toc-label=getint }
...
### *obj*.**items**`#!py3 (self, section=<object object at 0x00E84920>, raw=False, vars=None)` { #items data-toc-label=items }
...
### *obj*.**pop**`#!py3 (self, key, default=<object object at 0x00E84098>)` { #pop data-toc-label=pop }
...
### **RawConfigParser**`#!py3 (defaults=None, dict_type=<class 'collections.OrderedDict'>, allow_no_value=False, *, delimiters=('=', ':'), comment_prefixes=('#', ';'), inline_comment_prefixes=None, strict=True, empty_lines_in_values=True, default_section='DEFAULT', interpolation=<object object at 0x00E84920>, converters=<object object at 0x00E84920>)` { #RawConfigParser-init data-toc-label="&lowbar;&lowbar;init&lowbar;&lowbar;" }
...
### *SafeConfigParser*.**converters** *class 'property'* default: *configparser.ConverterMapping object at 0x03C5A610* { #converters data-toc-label=converters }
